...
public class StudentDatabase {
	...
	void toDisplaybyId(Connection connection) throws NullPointerException, SQLException {
		PreparedStatement prepstmnt = connection.prepareStatement("SELECT * FROM student WHERE studentId = ? ");  
	...
	void toUpdate(Connection connection) throws NullPointerException, SQLException{
        ...
        PreparedStatement updateStmt = connection.prepareStatement("UPDATE student SET studentName = ? WHERE studentId = ?");
